...
class Proposicao(db.Model):
    ...
    db.Index("idx_proposicoes_autor_id", "autor_id"),
    ...
    autor_id = db.Column(db.Integer, db.ForeignKey("autores.id"), nullable=True, index=True)
...
class Favorito(db.Model):
    ...
    db.UniqueConstraint(
        "usuario_id",
        "proposicao_id",
        name="uq_favorito_usuario_proposicao"
    ),

    db.Index(
        "idx_favoritos_usuario_proposicao",
        "usuario_id",
        "proposicao_id"
    ),
)
